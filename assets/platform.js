...
function shellFooter(){return `<div class="footer"><div class="footerlinks"><a href="/">홈</a><a href="/today.html">오늘운</a><a href="/love.html">연애실험실</a><a href="/family.html">우리집 관계도</a><a href="/dream/">꿈해몽</a><a href="/encyclopedia/">60갑자</a><a href="/privacy.html">개인정보</a><a href="/terms.html">이용약관</a></div>연결운 · 오락/참고용 관계 콘텐츠</div>`}
return{DAY_SECT,isLateNight,$,clamp,person,pair,todayScores,dayKey,fmtDate,hash,jitter,copy,toast,metricHTML,shellFooter,engineReady,parseDate,similarity,prop,complement,elemRel,branchRel,branchEnergy,weights,STEMS,BRANCHES,STEM_E,BRANCH_E,ELEMENTS,GEN,CTRL,STEM_COMB,STEM_CLASH,SIX_COMB,CLASH,HARM,BREAK,PUNISH};
})();
